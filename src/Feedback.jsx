    ...
    <div>
      ...
      {analysisResult?.camera_angle_warning && (
        <div style={{
          ...
          <svg width="16" height="16" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" style={{ flexShrink: 0 }}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3.75h10.5a2.25 2.25 0 0 1 2.25 2.25v12a2.25 2.25 0 0 1-2.25 2.25H6.75a2.25 2.25 0 0 1-2.25-2.25V6a2.25 2.25 0 0 1 2.25-2.25Zm0 0v16.5m0-13.5h3m-3 3h2.25m-2.25 3h3m-3 3h2.25" />
          </svg>
          <span>{analysisResult.camera_angle_warning}</span>
        </div>
      )}
      ...
      {analysisResult && typeof analysisResult.tracking_quality === 'number' && analysisResult.tracking_quality < 60 && (
        <div style={{
          ...
          <span>Low tracking quality ({Math.round(analysisResult.tracking_quality)}%). Stand fully in frame with good lighting for a reliable score.</span>
        </div>
      )}
                  ...
                  return (
                    ...
                    >
                      <span style={{ color: '#cbd5e1', display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 500 }}>
                        {NANO_ICONS[item.key] ? (
                          <img src={NANO_ICONS[item.key]} alt="" style={{ width: '20px', height: '20px', borderRadius: '5px', objectFit: 'cover' }} />
                        ) : (
