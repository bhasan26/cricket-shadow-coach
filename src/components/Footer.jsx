    ...
    <footer className="courto-footer">
      <div className="footer-blob-container">
        ...
        <div className="footer-blob-left">
          <h2 className="footer-blob-title">
            COACHING FOR ALL<br />
            LEVELS & FOR ALL AGES
          </h2>
        ...
        {/* Middle Column */}
        <div className="footer-blob-middle">
          ...
          <div className="footer-pill-links">
            ...
            <a href="#about" onClick={(e) => { e.preventDefault(); onNavigate('home'); }}>ABOUT US</a>
            <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('privacy'); }}>PRIVACY</a>
            <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('terms'); }}>TERMS</a>
            <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('contact'); }}>CONTACTS</a>
          </div>
        </div>
        ...
        <div className="footer-blob-right">
          <p className="footer-address">
            9718 N STEVENS STREET<br />
            bhasan26@icloud.com
          </p>
          <a href="tel:+16097017561" className="courto-btn courto-btn-primary footer-phone-btn">
            +1 609 701 7561
      ...
      <div className="footer-bottom">
        ...
        <p className="footer-copyright">Copyright &copy; 2026 CricketCoach by Bilal Hasan. All Rights Reserved</p>
      </div>
    </footer>
  );
}
